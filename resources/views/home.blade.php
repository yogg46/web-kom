                            ...
                            <div class="pb-3 mb-3 border-bottom">
                                ...
                                <div class="d-flex align-items-end">
                                    <img src="images/profile/21.jpg" alt="" width="42"
                                        class="rounded-circle mr-2">
                                    <div class="mr-auto">
                                        <h4 class="fs-14 mb-0"><a href="app-profile.com" class="text-black">Jacob Swing
                                                Swing</a></h4>
                            ...
                            <div class="pb-3 mb-3 border-bottom">
                                ...
                                <div class="d-flex align-items-end">
                                    <img src="images/profile/22.jpg" alt="" width="42"
                                        class="rounded-circle mr-2">
                                    <div class="mr-auto">
                                        <h4 class="fs-14 mb-0"><a href="app-profile.com" class="text-black">Robert
                                                Carloz</a></h4>
                            ...
                            <div class="pb-3 mb-3 border-bottom">
                                ...
                                <div class="d-flex align-items-end">
                                    <img src="images/profile/23.jpg" alt="" width="42"
                                        class="rounded-circle mr-2">
                                    <div class="mr-auto">
                                        <h4 class="fs-14 mb-0"><a href="app-profile.com" class="text-black">Kevin
                                                Stefanus</a></h4>
                                        <span class="fs-12">2m ago</span>
                                    </div>
                                    <span class="badge badge-sm light badge-primary">1 Ticket</span>
