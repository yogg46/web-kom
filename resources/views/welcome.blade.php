                    ...
                    <div class="navigation-inner">
                        <div class="navigation-logo">
                            <a class="logo" href="index.html">
                                <img src="/asset/images/Kominfo.png" style=" height: 50px" alt="orions-logo">
                            </a>
                            <a class="logo-white" href="index.html">
                                <img src="/asset/images/Kominfo2.png" style=" height: 50px" alt="orions-logo">
                            </a>
                        </div>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-7 offset-lg-0 order-lg-1 col-md-8 offset-md-2 col-10 offset-1 order-2">
                            <div class="feature-section-content">
                                ...
                                <p class="c-grey">Seed doesn't he dry, male creepeth god them their in which by
                                    firmament to days two deep yielding darkness bring likeness.</p>
                                <div class="icon-text-group">
                                    <div class="icon-text">
                                        <i class="las la-server"></i>
                                        <h4 class="c-dark">Unlimited Storage</h4>
                                        <p class="c-grey">Heat multiply is second divided fowl there isn't man cattle.
                                        </p>
                                    </div>
                                    <div class="icon-text">
                                ...
                                <div class="icon-text-1-group">
                                    <div class="icon-text-1">
                                        ...
                                        <div>
                                            ...
                                            <p class="c-grey">He saw lesser whales man air. Seasons void fly replenish
                                                man divided open fifth own fruitful.</p>
                                        </div>
                                    </div>
                                    <div class="icon-text-1">
                                        <i class="las la-headset"></i>
                                        <div>
                                            ...
                                            <p class="c-grey">Give whales creeping sixth. Blessed itself created dry
                                                they're firmament face whose face lesser spirit day dry.</p>
                                        </div>
                                    </div>
                                    <div class="icon-text-1">
                                        <i class="las la-photo-video"></i>
                                        <div>
                                            ...
                                            <p class="c-grey">Waters seasons of place likeness good day let they're
                                                evening replenish years of over that.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col">
                                <div class="switch">
                                    <div class="form-check form-switch">
                                        <label class="form-check-label" for="price-switch">Monthly</label>
                                        <input class="form-check-input" type="checkbox" id="price-switch"
                                            checked="checked">
                                        <label class="form-check-label" for="price-switch">Annual</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="faq-collapse-1" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>Prepare questions that the patient should answer when registering for
                                                    an online
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header" id="faq-2">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                data-bs-target="#faq-collapse-2" aria-expanded="true"
                                                aria-controls="faq-collapse-2">
                                                <span>What's your cancellation policy?</span>
                                            </button>
                                        </div>
                                        <div id="faq-collapse-2" class="accordion-collapse collapse show"
                                            aria-labelledby="faq-2" data-bs-parent="#faq-accordion">
                                            <div class="accordion-body">
                                                <p>Prepare questions that the patient should answer when registering for
                                                    an online
                                                    there consultation. We will send them to him before the visit in the
                                ...
                                -->
                                    <div class="accordion-item">
                                        ...
                                        <div id="faq-collapse-3" class="accordion-collapse collapse"
                                            aria-labelledby="faq-3" data-bs-parent="#faq-accordion">
                                            <div class="accordion-body">
                                                <p>Prepare questions that the patient should answer when registering for
                                                    an online
                                                    there consultation. We will send them to him before the visit in the
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header" id="faq-5">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="true" aria-controls="faq-collapse-5">
                                                <span>Can I preview before I publish?</span>
                                            </button>
                                        </div>
                                        <div id="faq-collapse-5" class="accordion-collapse collapse"
                                            aria-labelledby="faq-5" data-bs-parent="#faq-accordion">
                                            <div class="accordion-body">
                                                <p>Prepare questions that the patient should answer when registering for
                                                    an online
                                                    there consultation. We will send them to him before the visit in the
                    ...
                    <div class="swiper-container">
                        ...
                        -->
                            <div class="swiper-slide">
                                <div class="screen-slide">
                                    <figure>
                                        <img src="/publik/assets/images/screens/screen-slider-img-1.png"
                                            alt="app-screen">
                                    </figure>
                                </div>
                            </div>
                        ...
                        -->
                            <div class="swiper-slide">
                                <div class="screen-slide">
                                    <figure>
                                        <img src="/publik/assets/images/screens/screen-slider-img-2.png"
                                            alt="app-screen">
                                    </figure>
                                </div>
                            </div>
                        ...
                        -->
                            <div class="swiper-slide">
                                <div class="screen-slide">
                                    <figure>
                                        <img src="/publik/assets/images/screens/screen-slider-img-3.png"
                                            alt="app-screen">
                                    </figure>
                                </div>
                            </div>
                        ...
                        -->
                            <div class="swiper-slide">
                                <div class="screen-slide">
                                    <figure>
                                        <img src="/publik/assets/images/screens/screen-slider-img-4.png"
                                            alt="app-screen">
                                    </figure>
                                </div>
                            </div>
                            ...
                            <div class="blog-single blog-single-1">
                                <div class="blog-single-wrapper">
                                    <div class="blog-single-content">
                                        ...
                                        <p>Behold creature him whose own doesn't god seasons winged two won't bearing
                                            herein fowl fruitful they went there beginning ... </p>
                                    </div>
